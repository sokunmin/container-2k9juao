...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-2k9juao.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-2k9juao.containers.anotherwebservice.com/
...
```
git clone git@github.com:sokunmin/container-2k9juao.git
cd container-2k9juao
```
...
```
docker attach container-2k9juao
```
